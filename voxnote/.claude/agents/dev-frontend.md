...
2. Mobile-first : l'UI se conçoit pour un écran de téléphone, le desktop est
   l'adaptation.
3. Détection de capacités à l'exécution (MediaRecorder.isTypeSupported), jamais
   de user-agent sniffing.
4. Tout état critique (enregistrement en cours, segments audio) persiste en
   IndexedDB : un refresh ne doit rien perdre.
