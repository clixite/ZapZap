...
3. RGPD : l'audio est supprimé après transcription ou après le délai défini, la
   suppression d'une note supprime audio ET texte, une page confidentialité existe.
4. Compatibilité iOS Safari respectée (voir la skill audio-web du projet).
5. Pas de sur-ingénierie : si une abstraction n'a qu'une implémentation et aucun
   besoin identifié, signale-la.
